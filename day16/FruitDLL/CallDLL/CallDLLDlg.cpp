...
#include "..\\FruitDLL\\MyHeader.h"
//#pragma comment(lib, "D:\\Training Related\\VC++ Training\\Six\\DLL\\DynamicLinking\\FruitDLL\\Debug\\TestDLL.lib")
...
CCallDLLDlg::CCallDLLDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CCallDLLDlg::IDD, pParent)
{
...
BOOL CCallDLLDlg::OnInitDialog()
{
	...
	try
	{
		fileobj.ReadFromFile(_T("D:\\MyFile.txt"));
	}
	catch(...)
	{
	...
	{
		m_Combo.AddString(fileobj.GetFruits());
	}
