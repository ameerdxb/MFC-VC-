...
CPatientDataDlg::CPatientDataDlg(CWnd* pParent /*=nullptr*/)
...
BEGIN_MESSAGE_MAP(CPatientDataDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CPatientDataDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
